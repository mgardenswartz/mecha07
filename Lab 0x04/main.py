...
if __name__ == "__main__":
    ...
    # Front Sensor Array
    frontSensorArray = sensorDriver(Pins=[ pyb.Pin.cpu.A7, 
                                            pyb.Pin.cpu.A6, 
                                            pyb.Pin.cpu.A4],
                                        whiteCalibration = [1748, 2843, 2903],
                                        blackCalibration = [3942, 4095, 4068]) 
    # Tasks
    ...
    pilot_Task = Task(pilotTask(sensor = frontSensorArray,
                                ...
                                encoderCPR=encoderCPR,
                                debug = debug,
                                revolutionLimit = revolutionLimit).run,
                      priority = 2,
                      period = 30)
    # Task Scheduler
